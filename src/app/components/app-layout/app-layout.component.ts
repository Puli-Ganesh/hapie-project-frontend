...
export class AppLayoutComponent implements OnDestroy {
  ...
  constructor(
    ...
    //       const restrictUris = ['/sign-document', '/canvas'];
    //       const isRestrictUri = restrictUris.some((restrictUri: string) => event.urlAfterRedirects.startsWith(restrictUri)) || (/^(\/[a-f\d]{24})?\/auth/i).test(event.urlAfterRedirects);
  ...
  // protected projectColor: number = 1;
